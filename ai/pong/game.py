...
class Game:
    ...
    def _draw_score(self):
        left_score_text = self.SCORE_FONT.render(str(self.left_score), True, self.WHITE)
        right_score_text = self.SCORE_FONT.render(str(self.right_score), True, self.WHITE)
    ...
    def _draw_hits(self):
        hits_text = self.SCORE_FONT.render(str(self.left_hits + self.right_hits), True, self.RED)
